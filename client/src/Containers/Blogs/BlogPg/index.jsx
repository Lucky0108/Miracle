...
const BlogPg = ({ match }) => {
  ...
  const renderBlog = () => {
    if (blogs.blog) {
      const { date, title, content, comments, author, tags } = blogs.blog;
      let shareUrl = `https://miracle-solutions.herokuapp.com${match.url}`;
      return blogs.error ? (
        <h1 className="alert-danger p-5"> {blogs.error} </h1>
      ) : (
        <div className="blog-content">
          <div className="post standard-format-image">
            ...
            <div className="date-entry-meta">
              <div className="entry-meta">
                ...
                <span>
                  By:
                  <a href={`/blogs/user/${author._id}`}> {author.firstName} </a>
                </span>
              </div>
            </div>
            {content}
          ...
          <div className="author-box">
            <div className="author-avatar">
              <img
                src={`${api}/blog/image/60abc94983a4ce418890b069`}
          ...
          <div className="comments-area">
            <div className="comments-section">
              ...
              { comments.length === 0 ?  <h3 className="text-center mt-3 text-success">Be The First One To Put Your Thoughts Here!</h3> : 
        ...
        <Container>
          <Row>
            <Col className="col" lg={12} xs={12}>
              {blogs.loading ? (
                <h1 className="alert-info p-5">Loading...</h1>
              ) : (
                renderBlog()
              )}
            </Col>
