      ...
      <div className="Home-div">
        ...
        <section className="section-padding portfolio-section home-section-4">
            <Container>
              <Row>
                <Col className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-md-1">
                  <HomeHeading class="home-section-4-heading clearfix" span="04. Portfolio" h2="Please check out recent our case studie" p="picture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame. It showed a lady fitted out with a fur" />
                </Col>
              </Row>
              <Row>
            ...
            <Row>
              <Col className="col-xs-12">
                ...
                <div className="content">
                  ...
                  <p>We are available 24*7 for you to reach out to us and resolve your queries or any doubt you have regading our services or with our website.</p>
                    ...
                    <div className="testimonial-content-active text-center">
                      <Slider {...sliderSettings}>
                        ...
                        <TestimonialGrid 
                          ...
                          para='"Dicture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame It showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered"' 
                          name="Lakshay Yadav" 
                          desig="Happy Client"  
                        />
                        ...
                        <TestimonialGrid 
                          ...
                          para='"Fuck You Dicture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame It showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered"' 
